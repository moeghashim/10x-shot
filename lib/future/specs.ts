          ...
          items: [
            {
              ...
              description: "Progress, track, roadmap cards, and the stack view should stay accurate and easy to inspect.",
            },
            {
              date: "Next",
          ...
          items: [
            {
              ...
              description: "التقدم والمتابعة وبطاقات خارطة الطريق وعرض التقنيات يجب أن تبقى دقيقة وسهلة الفحص.",
            },
            {
              date: "التالي",
